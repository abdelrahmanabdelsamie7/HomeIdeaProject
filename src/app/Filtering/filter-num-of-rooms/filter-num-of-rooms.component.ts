...
@Component({
  selector: 'app-filter-num-of-rooms',
  templateUrl: './filter-num-of-rooms.component.html',
  styleUrls: ['./filter-num-of-rooms.component.css'],
})
export class FilterNumOfRoomsComponent {
  roomCount: number = 1;
