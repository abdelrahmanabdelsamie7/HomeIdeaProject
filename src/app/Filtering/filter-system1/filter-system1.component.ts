...
@Component({
  selector: 'app-filter-system1',
  templateUrl: './filter-system1.component.html',
  styleUrls: ['./filter-system1.component.css'],
})
export class FilterSystem1Component {
  center: google.maps.LatLngLiteral = { lat: 26.559828, lng: 31.695805 };
  zoom = 12;
  AllPostions!: any[];
  constructor() {
    this.AllPostions = [
      { lat: 26.559828, lng: 31.695805 },
      { lat: 26.54732015, lng: 31.695805 },
    ];
